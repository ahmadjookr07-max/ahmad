...
class RefineOptions:
    ...
    # ملاحظة مقيسة: لصور المنتجات ذات النصوص والخلفية البيضاء، ينتج
    # lossless (101) ملفًا أصغر من الضغط المفقود 95–100 مع تطابق تام؛
    # لذا يُنصح بإبقاء compress معطّلًا دائمًا.
    compress_quality: int = 97      # جودة الضغط (عالية جدًا — تحافظ على حقائق المنتج)
