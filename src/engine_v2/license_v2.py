...
OWNER_PUBLIC_KEY_B64 = "Uclm9VjzcVvWwaL0YkvW/pOAjMgEVBjHLPSFcs1MJ6c="
# مفتاح ML-DSA-65 العام اختياري: إن وُضع يُتحقق من التوقيع الهجين أيضًا.
# هذا الإصدار يطابق شفرة المالك الحالية بتوقيع Ed25519 إلزامي وربط بصمة
# الجهاز؛ تركه فارغًا لا يسمح بأي مفتاح غير موقّع.
OWNER_PQC_PUBLIC_KEY_B64 = ""
